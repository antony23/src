...
public class CityConnect {
	...
	public static String executeCommand(String userCommand) {
		...
		case INVALID:
			return String.format(MESSAGE_INVALID_FORMAT, userCommand);
		case EXIT:
			System.exit(1); //changed but no use
		default:
	...
	private static COMMAND_TYPE determineCommandType(String commandTypeString) {
		...
		return optionsAvailable(commandTypeString);
	}

	private static COMMAND_TYPE optionsAvailable(String commandTypeString) {// added a new method to options Available
	...
	private static String getDistance(String userCommand) {
		...
		return distanceCalculated(parameters);

	}

	private static String distanceCalculated(String[] parameters) {
		...
		{
			return distance(newStartLocation, newEndLocation, position);//changed
		}
	}

	private static String distance(String newStartLocation,
	...
	private static boolean sameRoute(String startLocation1,
		...
		return checkSame(startLocation1, endLocation1, startLocation2,
				endLocation2); // added another
		
	}

	private static boolean checkSame(String startLocation1,
			String endLocation1, String startLocation2, String endLocation2) {
